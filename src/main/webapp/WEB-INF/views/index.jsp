			...
			<div class="col-3">
				...
				<div class="right">
					...
					<ul class="list-unstyled">
						<c:forEach items="${articleofImages }" var="item">
						<li class="media">
				...
				<div>
					<div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							<c:forEach items="${hotArticleInfo.list }" var="a">
								<div class="media">
									<img src="${a.picture }" class="mr-3" alt="..."
										width="72px" height="60px">
									<div class="media-body">
										<h6>
											<a href="/article/detail/${a.id }.html" target="_blank">${a.title }</a>
										</h6>
									</div>
								</div>
								<br>
